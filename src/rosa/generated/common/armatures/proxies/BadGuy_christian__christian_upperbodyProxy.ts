...
export class BadGuy_christian__christian_upperbodyProxy extends ProxyBase implements IArmatureProxy {


	// private Untitled-1_66.png:dragonBones.Armature;
	...
	// Child Armatures
	// public getUntitled_1_66_png():BadGuy_christian__chrHeadProxy {
	// 	return new BadGuy_christian__chrHeadProxy(this.Untitled-1_66.png);
	// }
	// Animations
