...
export class MilleInCardProxy extends ProxyBase implements IArmatureProxy {
	

	protected front_head:dragonBones.Armature;
...
// < Child Armatures >
public getFront_head():MilleFront_headProxy
	{
		return new MilleFront_headProxy(this.front_head);
	}
// </ Child Armatures >
// < Animations >
