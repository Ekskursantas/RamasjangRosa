...
export class BadGuy_bamse__caracterProxy extends ProxyBase implements IArmatureProxy {
	...
	constructor(armature:dragonBones.Armature) {
		...
		Logger.log(this, "BadGuy_bamse__caracterProxy this._armature == "+this._armature);
