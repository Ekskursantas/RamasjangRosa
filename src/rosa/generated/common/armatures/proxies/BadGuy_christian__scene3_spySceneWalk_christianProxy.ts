...
import {BadGuy_christian__caracterProxy} from "src/rosa/generated/common/armatures/proxies/BadGuy_christian__caracterProxy";
import {TypedDBFactory} from "src/rosa/generated/common/armatures/TypedDBFactory";
import {ProxyBase} from "src/rosa/generated/common/armatures/ProxyBase";
import {Logger} from "../../../../../loudmotion/utils/debug/Logger";

export class BadGuy_christian__scene3_spySceneWalk_christianProxy extends ProxyBase implements IArmatureProxy,ISpyScene {
	...
	constructor(armature:dragonBones.Armature) {
		...
		Logger.log(this, "BadGuy_christian__scene3_spySceneWalk_christianProxy armature.animation.animationNames.toString() == "+this._armature.animation.animationNames.toString());
	...
	// < Child Armatures >
	public getCharacter():BadGuy_christian__caracterProxy {
		Logger.log(this, "BadGuy_christian__scene3_spySceneWalk_christianProxy getCharacter this.character == "+this.character);
		return new BadGuy_christian__caracterProxy(this.character);
	}
	// </ Child Armatures >
	// < Animations >
