...
import {Disquise_christianProxy} from "src/rosa/generated/common/armatures/proxies/Disquise_christianProxy";
import {TypedDBFactory} from "src/rosa/generated/common/armatures/TypedDBFactory";
import {ProxyBase} from "src/rosa/generated/common/armatures/ProxyBase";
import {Logger} from "../../../../../loudmotion/utils/debug/Logger";

export class DisguiseBubbleChristianProxy extends ProxyBase implements IArmatureProxy {
...
// < Child Armatures >
public getDisquise():Disquise_christianProxy
	{
		return new Disquise_christianProxy(this.disquise);
	}
// </ Child Armatures >
// < Animations >
public gotoUp():void
...
public gotoDisabled():void
	{
		Logger.log(this, "DisguiseBubbleChristianProxy gotoDisabled this._armature.animation.lastAnimationName == "+this._armature.animation.lastAnimationName);
