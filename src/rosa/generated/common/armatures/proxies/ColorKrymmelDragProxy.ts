...
export class ColorKrymmelDragProxy extends ProxyBase implements IArmatureProxy,IDragable {
	...
	constructor(armature:dragonBones.Armature) {
		super();
		this.proxyName = "ColorKrymmelDragProxy";
	...
	public getDecoArmature = ():dragonBones.Armature => {
		let armature:dragonBones.Armature = AssetLoader.getInstance().typeddb._factory.buildArmature("deco/colorKrymmelDrag");
		return armature;
	}
