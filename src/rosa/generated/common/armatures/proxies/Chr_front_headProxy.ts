...
export class Chr_front_headProxy extends ProxyBase implements IArmatureProxy {
	...
	constructor(armature:dragonBones.Armature) {
		...
		Logger.log(this, "Chr_front_headProxy armature.animation.animationNames.toString() == "+this._armature.animation.animationNames.toString());
...
public gotoDefault():void
	{
		Logger.log(this, "Chr_front_headProxy gotoDefault armature.animation.animationNames.toString() == "+this._armature.animation.animationNames.toString());
		this.gotoIdle();
