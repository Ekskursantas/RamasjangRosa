...
export class StrawberryDragProxy extends ProxyBase implements IArmatureProxy,IDragable {
	...
	constructor(armature:dragonBones.Armature) {
		super();
		this.proxyName = "StrawberryDragProxy";
	...
	public getDecoArmature = ():dragonBones.Armature => {
		let armature:dragonBones.Armature = AssetLoader.getInstance().typeddb._factory.buildArmature("deco/strawberryDrag");
		return armature;
	}
