...
export class BadGuy_christian__prebenHeadProxy extends ProxyBase implements IArmatureProxy {
	...
	constructor(armature:dragonBones.Armature) {
		...
		Logger.log(this, "BadGuy_christian__prebenHeadProxy armature.animation.animationNames.toString() == "+this._armature.animation.animationNames.toString());
	...
	public gotoTalk():void {
		...
		{
			Logger.log(this, "BadGuy_christian__prebenHeadProxy gotoTalk");
