...
export class BlueKrymmelDragProxy extends ProxyBase implements IArmatureProxy,IDragable {
	...
	constructor(armature:dragonBones.Armature) {
		super();
		this.proxyName = "BlueKrymmelDragProxy";
	...
	public getDecoArmature = ():dragonBones.Armature => {
		let armature:dragonBones.Armature = AssetLoader.getInstance().typeddb._factory.buildArmature("deco/blueKrymmelDrag");
		return armature;
	}
