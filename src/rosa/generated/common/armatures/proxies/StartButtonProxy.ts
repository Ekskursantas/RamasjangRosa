...
export class StartButtonProxy extends ProxyBase implements IArmatureProxy {
	...
	public gotoDown():void {
		Logger.log(this, "StartButtonProxy gotoDown == "+this._armature.animation.lastAnimationName);
		if (this._armature.animation.lastAnimationName != "down") {
			this._armature.animation.play("down");
		}
	}
	public gotoDisabled():void {
		Logger.log(this, "StartButtonProxy gotoDisabled == "+this._armature.animation.lastAnimationName);
		if (this._armature.animation.lastAnimationName != "disabled") {
			let animation = this._armature.animation.play("disabled");
		}
	}
	// </ Animations >
	// < Animations aliases >
	...
	public set display(newDisplay:PIXI.Sprite) {
		Logger.log(this, "StartButtonProxy this._armature.getSlots().length == "+this._armature.getSlots().length);
