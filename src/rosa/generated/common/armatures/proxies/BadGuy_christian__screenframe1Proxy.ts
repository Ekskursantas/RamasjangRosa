...
export class BadGuy_christian__screenframe1Proxy extends ProxyBase implements IArmatureProxy {
	...
	constructor(armature:dragonBones.Armature) {
		...
		Logger.log(this, "BadGuy_christian__screenframe1Proxy armature.animation.animationNames.toString() == "+armature.animation.animationNames.toString());
