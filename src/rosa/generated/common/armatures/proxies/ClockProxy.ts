...
export class ClockProxy extends ProxyBase implements IArmatureProxy {
...
public gotoTimer():void
	{
		if (this._armature.animation.lastAnimationName != "timer")
		{
			this._armature.animation.play("timer");
		}
	}
