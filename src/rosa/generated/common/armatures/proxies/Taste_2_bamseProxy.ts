...
import {HonningDropProxy} from "src/rosa/generated/common/armatures/proxies/HonningDropProxy";
import {TypedDBFactory} from "src/rosa/generated/common/armatures/TypedDBFactory";

export class Taste_2_bamseProxy extends ProxyBase implements IArmatureProxy,IDragable {
	
	private honeyDrop:dragonBones.Armature;
...
// < Child Armatures >
public getHoneyDrop():HonningDropProxy
	{
		return new HonningDropProxy(this.honeyDrop);
	}
// </ Child Armatures >
// < Animations >
