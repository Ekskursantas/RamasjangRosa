...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.CharCardFrame2Proxy;
...
export class CharCardFrame2Button extends CharCardFrame2Proxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:CharCardFrame2Proxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as CharCardFrame2Proxy;
