...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.DisguiseBubbleChristianProxy;
...
export class DisguiseBubbleChristianButton extends DisguiseBubbleChristianProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:DisguiseBubbleChristianProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as DisguiseBubbleChristianProxy;
	...
	public set disabled(value:boolean) {
		...
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as DisguiseBubbleChristianProxy;
		Logger.log(this, "DisguiseBubbleChristianButton set disabled this.btn == "+this.btn+" : this._disabled == "+this._disabled);
		if (this._disabled) {
