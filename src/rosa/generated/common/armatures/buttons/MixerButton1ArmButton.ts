...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.MixerButton1ArmProxy;
...
export class MixerButton1ArmButton extends MixerButton1ArmProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:MixerButton1ArmProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as MixerButton1ArmProxy;
