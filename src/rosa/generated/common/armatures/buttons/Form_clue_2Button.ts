...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.Form_clue_2Proxy;
...
import {Form_clue_2Proxy} from "src/rosa/generated/common/armatures/proxies/Form_clue_2Proxy";
...
export class Form_clue_2Button extends Form_clue_2Proxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:Form_clue_2Proxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as Form_clue_2Proxy;
