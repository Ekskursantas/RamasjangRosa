...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.StopButtonProxy;
...
import {StopButtonProxy} from "src/rosa/generated/common/armatures/proxies/StopButtonProxy";
...
export class StopButtonButton extends StopButtonProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:StopButtonProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as StopButtonProxy;
