...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.DisguiseBubbleSkaegProxy;
...
export class DisguiseBubbleSkaegButton extends DisguiseBubbleSkaegProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:DisguiseBubbleSkaegProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as DisguiseBubbleSkaegProxy;
