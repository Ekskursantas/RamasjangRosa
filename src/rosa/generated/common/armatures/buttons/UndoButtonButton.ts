...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.UndoButtonProxy;
...
export class UndoButtonButton extends UndoButtonProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:UndoButtonProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as UndoButtonProxy;
