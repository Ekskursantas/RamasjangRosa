...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.MixerButton2ArmProxy;
...
export class MixerButton2ArmButton extends MixerButton2ArmProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:MixerButton2ArmProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as MixerButton2ArmProxy;
