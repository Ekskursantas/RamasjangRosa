...
export class Form_clueButton extends Form_clueProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:Form_clueProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as Form_clueProxy;
		...
		Logger.log(this, "Form_clueButton this.btn constructor == "+this.btn);
	}
	...
	public set disabled(value:boolean) {
		Logger.log(this, "Form_clueButton this.btn == "+this.btn);
		Logger.log(this, "Form_clueButton disabled == "+value);
	...
	public set selected(value:boolean) {
		Logger.log(this, "Form_clueButton this.btn selected == "+this.btn);
