...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.StartButtonGameProxy;
...
import {StartButtonGameProxy} from "src/rosa/generated/common/armatures/proxies/StartButtonGameProxy";
...
export class StartButtonGameButton extends StartButtonGameProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:StartButtonGameProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as StartButtonGameProxy;
