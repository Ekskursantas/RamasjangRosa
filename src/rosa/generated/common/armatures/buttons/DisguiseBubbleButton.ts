...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.DisguiseBubbleProxy;
...
import {DisguiseBubbleProxy} from "src/rosa/generated/common/armatures/proxies/DisguiseBubbleProxy";
...
export class DisguiseBubbleButton extends DisguiseBubbleProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:DisguiseBubbleProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as DisguiseBubbleProxy;
	...
	// private buttonTouched(event:TouchEvent):void {
	// 	let touch:Touch = event.getTouch(this.armature.display as PIXI.DisplayObject, TouchPhase.ENDED);
	// 	if (touch) {
	// 		let btn:DisguiseBubbleProxy = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as DisguiseBubbleProxy;
    //
	// 		if (this._disabled) {
	// 			return;
	// 		}
