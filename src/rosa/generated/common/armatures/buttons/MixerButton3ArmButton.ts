...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.MixerButton3ArmProxy;
...
export class MixerButton3ArmButton extends MixerButton3ArmProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:MixerButton3ArmProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as MixerButton3ArmProxy;
