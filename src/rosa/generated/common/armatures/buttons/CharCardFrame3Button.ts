...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.CharCardFrame3Proxy;
...
export class CharCardFrame3Button extends CharCardFrame3Proxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:CharCardFrame3Proxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as CharCardFrame3Proxy;
