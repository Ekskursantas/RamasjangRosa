...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.CharCardFrame1Proxy;
...
export class CharCardFrame1Button extends CharCardFrame1Proxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:CharCardFrame1Proxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as CharCardFrame1Proxy;
