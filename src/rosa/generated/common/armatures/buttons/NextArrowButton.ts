...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.NextArrowProxy;
...
export class NextArrowButton extends NextArrowProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	public btn:NextArrowProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as NextArrowProxy;
		...
		this.armature.display.on(TouchEvent.TOUCH_OUT, this.touchOut);
