...
//	import dk.nozebra.rosa.generated.common.armatures.proxies.CharCardFrameProxy;
...
import {CharCardFrameProxy} from "src/rosa/generated/common/armatures/proxies/CharCardFrameProxy";
...
export class CharCardFrameButton extends CharCardFrameProxy implements IButtonProxy {
	private _selected:boolean;
	private _disabled:boolean;
	private _isToggle:boolean;
	private btn:CharCardFrameProxy;

	constructor(armature:dragonBones.Armature) {
		super(armature);
		this._selected = false;
		this.btn = TypedDBFactory.getProxyFromDisplay(this.armature.display as PIXI.DisplayObject) as CharCardFrameProxy;
